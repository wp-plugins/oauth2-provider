<?php
/*
Plugin Name: WP OAuth2 Complete Provider
...
CREDITS:
Thanks to all the community members for stepping in and helping with this plugin. It is truly awesome to see code not go to waste.

INFORMATON:
If you would like to contribute to this plugin or you have an issue/suggestion, please visit the projects home at https://github.com/justingreerbbi/wordpress-oauth
*/
